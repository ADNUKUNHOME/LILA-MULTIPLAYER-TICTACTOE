        ...
        <div className="min-h-screen bg-black text-white p-3 sm:p-4 md:p-6">
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-3xl shadow-2xl shadow-yellow-500/25 mb-6">
                        <Trophy className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" />                    </div>
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-yellow-200 mb-4">
                        Leaderboard
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl text-purple-200 max-w-2xl mx-auto leading-relaxed px-2">
                        Compete with the best strategists and climb to the top of the rankings
                    </p>
                </div>

                {/* Stats Cards */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12">                    <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 text-center transform hover:scale-105 transition-all duration-300 hover:bg-white/15">
                ...
                {/* Buttons Section */}
                <div className="flex flex-col sm:flex-row justify-center gap-4 mt-12 mb-8">                    <button
                    onClick={() => router.push("/")}
                    className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-xl font-semibold transition-all duration-300 border border-white/10 hover:border-white/20"
                >
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-6 py-3 rounded-xl font-semibold transition-all duration-300"
                    >
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 overflow-hidden shadow-2xl shadow-purple-500/10">
                    <div className="overflow-x-auto">
                        <div className="grid grid-cols-12 min-w-[800px] gap-4 p-6 border-b border-white/10 bg-white/5 font-semibold text-purple-200">
                        ...
                        <div className="divide-y divide-white/10">
                            {leaderboard.map((player, index) => (
                                <div
                                    key={player._id}
                                    className={`grid grid-cols-12 gap-4 p-4 md:p-6 border-b border-white/10 bg-white/5 font-semibold text-purple-200 min-w-[800px] group ${index < 3 ? `bg-gradient-to-r ${getRankColor(index)}` : ""
                                        }`}
                                >
                                    {/* Rank */}
                                    ...
                                    <div className="col-span-4 flex items-center">
                                        ...
                                        <div>
                                            <div className="font-semibold text-sm sm:text-base lg:text-lg group-hover:text-white transition-colors break-words">
                                    ...
                                    <div className="col-span-3 flex items-center justify-center">
                                        <span className="bg-gradient-to-r from-purple-500 to-blue-500 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-2xl text-sm sm:text-base lg:text-lg font-bold shadow-lg shadow-purple-500/25 transform group-hover:scale-110 transition-transform">
                                            {player.score} pts
                                        </span>
                                    </div>
                                </div>
                    ...
                    {/* Footer */}
                    <div className="text-center mt-12 mb-5 text-gray-400">
